  ...
  return (
    <div className="container max-w-[1164px] ">
      <div className="rounded-[41px] bg-light-sky inline-flex items-center gap-2.5 p-[10px_31px_10px_31px]">
        ...
        <span className="font-open font-normal leading-normal text-base text-light-blue uppercase">
          features
        </span>
      </div>
      <h1 className="font-Anek font-semibold text-5xxl text-black !leading-[120%] mt-5">
        Stratman AI <span className="font-[200]">helps Achieve</span>{" "}
        <span className="text-light-blue">Your Goals</span>
      </h1>
      <p className="font-open font-normal text-base text-dark-gray leading-normal mt-3">
      ...
      <div className="flex flex-row flex-wrap -mx-3 pt-[100px] items-center">
